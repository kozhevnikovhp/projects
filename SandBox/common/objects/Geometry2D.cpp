...
{
	::SnapToGrid(m_fX, fGridSize);
	::SnapToGrid(m_fY, fGridSize);
}
...
{
	m_fLeft = +VERY_BIG_DOUBLE;
	m_fRight = -VERY_BIG_DOUBLE;
	m_fBottom = +VERY_BIG_DOUBLE;
	m_fTop = -VERY_BIG_DOUBLE;
}
...
//virtual
void CPoint2D::Format(CTextString &str)
{
	char szData[64];
...
//virtual
void CLine2D::Format(CTextString &str)
{
	char szData[128];
...
LOGICAL CRectangle2D::IsPointInside(double x, double y)
{
...
//virtual
void CRectangle2D::Format(CTextString &str)
{
	char szData[128];

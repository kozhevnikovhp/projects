...
{
    class ZDataGridViewNumberBoxCell : DataGridViewTextBoxCell, IZDataGridViewCell
    {
        #region Fields
        private int valueColumnSpan = 1;
        private int valueRowSpan = 1;
        private ZDataGridViewNumberBoxCell valueOwnerCell;
        #endregion

        public ZDataGridViewNumberBoxCell()
        {
        ...
        public DataGridViewCell OwnerCell
        {
            ...
            set { valueOwnerCell = value as ZDataGridViewNumberBoxCell; }
        }
        ...
        protected override object GetFormattedValue(object value, int rowIndex, ref DataGridViewCellStyle cellStyle, TypeConverter valueTypeConverter, TypeConverter formattedValueTypeConverter, DataGridViewDataErrorContexts context)
        {
            ...
            if (this.OwningColumn.Name == ZStringConstants.ParameterIDZdiff_BitRate && !ZPlannerManager.ProjectIsEmpty && !ZPlannerManager.Project.StackupIsEmpty)
            {
                ...
                else
                {
                    ...
                    if (double.IsNaN(frequency)) value = null;
                    else value = 2 * frequency;
                }
            }
            ...
            if (this.OwningColumn.Name == ZStringConstants.ParameterIDZdiff_UnitInterval && !ZPlannerManager.ProjectIsEmpty && !ZPlannerManager.Project.StackupIsEmpty)
            {
                ...
                else
                {
                    ...
                    if (double.IsNaN(frequency) || frequency == 0) value = null;
                    else value = 500 / frequency;
                }
            }
            ...
            {
                if (value != null && double.TryParse(value.ToString().Trim(), NumberStyles.Any, CultureInfo.InvariantCulture, out dValue))
                    return dValue.ToString("N" + Settings.Options.TheOptions.lengthDigits, CultureInfo.InvariantCulture);
            }
            else if (value != null && double.TryParse(value.ToString().Trim(), NumberStyles.Any, CultureInfo.InvariantCulture, out dValue))
            {
        ...
        protected override void Paint(Graphics graphics, Rectangle clipBounds, Rectangle cellBounds, int rowIndex, DataGridViewElementStates cellState, object value, object formattedValue, string errorText, DataGridViewCellStyle cellStyle, DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            ...
            using (var g = DataGridView.CreateGraphics())
            {
                ...
                if ((paintParts & DataGridViewPaintParts.Border) != DataGridViewPaintParts.None)
                {
                    ...
                    var rightBottomCell = DataGridView[columnIndex + columnSpan - 1, rowIndex + rowSpan - 1] as ZDataGridViewNumberBoxCell ?? this;
        ...
        private void SetSpan(int columnSpan, int rowSpan)
        {
            ...
            if (DataGridView != null)
            {
                ...
                for (int rowIndex = RowIndex; rowIndex < RowIndex + prevRowSpan; rowIndex++)
                    ...
                    {
                        var cell = DataGridView[columnIndex, rowIndex] as ZDataGridViewNumberBoxCell;
                        if (cell != null)
                            cell.OwnerCell = null;
                    }
        ...
        protected override Rectangle BorderWidths(DataGridViewAdvancedBorderStyle advancedBorderStyle)
        {
            ...
            var rightBottomCell = DataGridView[
                ...
                RowIndex + RowSpan - 1] as ZDataGridViewNumberBoxCell;

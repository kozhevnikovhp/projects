...
{
    public enum ZDataGridViewFilterType : byte
    {
        None = 0,
        Custom,
        CheckList
    ...
    public enum ZDataGridViewSortType : byte
    {
        None = 0,
        ASC,
        DESC
    ...
    public enum ZDataGridViewFilterMenuDateTimeGrouping : byte
    {
        None = 0,
        Year,
        Month,
    ...
    public enum ZDataGridViewFilterMenuDataType : byte
    {
        Text = 0,
        Int,
        Float,
    ...
    public class ZDataGridViewFilterMenu : ContextMenuStrip
    {
        #region Controls
        ...
        private ZDataGridViewFilterMenuDateTimeGrouping dateTimeGrouping = ZDataGridViewFilterMenuDateTimeGrouping.Second;

        public ZDataGridViewFilterMenuDataType DataType { get; private set; }

        public TripleTreeNode AllsNode { get { return allsNode; } }

        public TripleTreeNode EmptysNode { get { return emptysNode; } }
        ...
        public ZDataGridViewFilterMenuDateTimeGrouping DateTimeGrouping 
        {
            ...
            set
            {
                if (this.dateTimeGrouping != value)
                {
                    ...
                    if (this.DataType == ZDataGridViewFilterMenuDataType.DateTime)
                    {
        ...
        public ZDataGridViewSortType ActiveSortType { get; private set; }

        public ZDataGridViewFilterType ActiveFilterType { get; private set; }
        ...
        public void InitializeComponent()
        {
            ...
            this.CancelSortMenuItem.Text = "Cancel sort";
            ...
            this.SetupFilterMenuItem.Text = "Custom";
            ...
            this.FiltersMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.ColumnFilter4;
            ...
            this.okButton.Size = new Size(82, 23);
            ...
            this.cancelButton.Size = new Size(82, 23);
            ...
            this.okButton.Location = new Point(this.CheckFilterListButtonsPanel.Width - 178, 0);
            this.cancelButton.Location = new Point(this.CheckFilterListButtonsPanel.Width - 86, 0);
            ...
            this.ActiveFilterType = ZDataGridViewFilterType.None;
            this.ActiveSortType = ZDataGridViewSortType.None;

            switch (this.DataType)
            {
                case ZDataGridViewFilterMenuDataType.DateTime:
                    this.FiltersMenuItem.Text = "Date filter";
                    this.SortASCMenuItem.Text = "Sort oldest to newest";
                    this.SortDESCMenuItem.Text = "Sort newest to oldest";
                    this.SortASCMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.SortASC_1_9;
                    this.SortDESCMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.SortDESC_9_1;
                    ...
                    break;
                case ZDataGridViewFilterMenuDataType.Boolean:
                    this.FiltersMenuItem.Text = "Text Filter";
                    this.SortASCMenuItem.Text = "Sort by No/Yes";
                    this.SortDESCMenuItem.Text = "Sort by Yes/No";
                    this.SortASCMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.ascbool;
                    this.SortDESCMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.descbool;
                    break;
                case ZDataGridViewFilterMenuDataType.Int:
                case ZDataGridViewFilterMenuDataType.Float:
                    this.FiltersMenuItem.Text = "Number filter";
                    this.SortASCMenuItem.Text = "Sort smallest to largest";
                    this.SortDESCMenuItem.Text = "Sort largest to smallest";
                    this.SortASCMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.SortASC_1_9;
                    this.SortDESCMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.SortDESC_9_1;
                    break;
                default:
                    this.FiltersMenuItem.Text = "Text Filter";
                    this.SortASCMenuItem.Text = "Sort А to Z";
                    this.SortDESCMenuItem.Text = "Sort Z to A";
                    this.SortASCMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.SortASC_A_Z;
                    this.SortDESCMenuItem.Image = global::ZZero.ZPlanner.Properties.Resources.SortDESC_Z_A;
                    break;
            }

            this.FiltersMenuItem.Enabled = this.DataType != ZDataGridViewFilterMenuDataType.Boolean;
            this.FiltersMenuItem.Checked = this.ActiveFilterType == ZDataGridViewFilterType.Custom;
        ...
        public ZDataGridViewFilterMenu(Type dataType)
            : base()
        {
            if (dataType == typeof(Boolean))
                this.DataType = ZDataGridViewFilterMenuDataType.Boolean;
            else if (dataType == typeof(DateTime))
                this.DataType = ZDataGridViewFilterMenuDataType.DateTime;
                ...
                this.DataType = ZDataGridViewFilterMenuDataType.Int;
            else if (dataType == typeof(Single) || dataType == typeof(Double) || dataType == typeof(Decimal))
                this.DataType = ZDataGridViewFilterMenuDataType.Float;
            else
                this.DataType = ZDataGridViewFilterMenuDataType.Text;

            //this.InitializeComponent();
        }

        public ZDataGridViewFilterMenu(ZDataGridViewFilterMenuDataType filterDataType)
            : base()
        {
        ...
        public object Clone()
        {
            ...
            ZDataGridViewFilterMenu m = new ZDataGridViewFilterMenu(this.DataType);
        ...
        public static IEnumerable<object> GetVisibleValuesForFilter(DataGridView grid, String columnName, bool useFormatedValue = false)
        {
            var vals =
                useFormatedValue ?
                    from DataGridViewRow r in grid.Rows
        ...
        public static IEnumerable<object> GetMaterialOfManufacturerValuesForFilter(IEnumerable<object> manufacturers, DataGridView grid, String columnName, bool useFormatedValue = false)
        {
            var vals =
                useFormatedValue ?
                    from DataGridViewRow r in grid.Rows
                    where r.IsNewRow == false && manufacturers.Contains(r.Cells[ZStringConstants.DMLParameterIDManufacturer].FormattedValue)
                    select r.Cells[columnName].FormattedValue
                :
                    from DataGridViewRow r in grid.Rows
                    where r.IsNewRow == false && manufacturers.Contains(r.Cells[ZStringConstants.DMLParameterIDManufacturer].Value)
                    select r.Cells[columnName].Value;

            return vals.Distinct();
        }

        public void Show(Control control, int x, int y, IEnumerable<object> vals, IEnumerable<object> valsToCheck)
        {
            this.LoadNodes(this.CreateNodesList(vals, valsToCheck));
        ...
        public void PrepareNodes(IEnumerable<object> vals)
        {
            this.LoadNodes(this.CreateNodesList(vals));
        }

        public void PrepareNodes(IEnumerable<object> vals, IEnumerable<object> valsToCheck)
        {
            this.LoadNodes(this.CreateNodesList(vals, valsToCheck));
        }
        ...
        {
            this.SetSorting(ZDataGridViewSortType.None, fireEvent);
        }
        ...
        private string DateTimeToNodeText(DateTime date, ZDataGridViewFilterMenuDateTimeGrouping grouping, bool showTime)
        {
            if (showTime)
            {
                switch (grouping)
                {
                    case ZDataGridViewFilterMenuDateTimeGrouping.Month:
                        return string.Format("{0:D2} {1:D2}:{2:D2}:{3:D2}.{4}", date.Day, date.Hour, date.Minute, date.Second, date.Millisecond.ToString("D3"));
                    case ZDataGridViewFilterMenuDateTimeGrouping.Day:
                        return string.Format("{0:D2}:{1:D2}:{2:D2}.{3}", date.Hour, date.Minute, date.Second, date.Millisecond.ToString("D3"));
                    case ZDataGridViewFilterMenuDateTimeGrouping.Hour:
                        return string.Format("{0:D2}:{1:D2}.{2}", date.Minute, date.Second, date.Millisecond.ToString("D3"));
                    case ZDataGridViewFilterMenuDateTimeGrouping.Minute:
            ...
            else
            {
                switch (grouping)
                {
                    case ZDataGridViewFilterMenuDateTimeGrouping.None:
                    case ZDataGridViewFilterMenuDateTimeGrouping.Year:
        ...
        private IEnumerable<TripleTreeNode> CreateNodesList(IEnumerable<object> values, IEnumerable<object> valuesToCheck = null)
        {
            ...
            if (values != null)
            {
                ...
                if (valsCnt > 0)
                {
                    TripleTreeNode allnode = TripleTreeNode.CreateAllsNode("(Select All)" + "            ");
                    if (valuesToCheck != null && values.Count() != valuesToCheck.Count()) allnode.Checked = false;
                    ...
                    {
                        TripleTreeNode nullnode = TripleTreeNode.CreateEmptysNode("(Blanks)" + "               ");
                    ...
                    if (nonullsCnt > 0)
                    {
                        if (this.DataType == ZDataGridViewFilterMenuDataType.DateTime)
                        {
                            ...
                            if (this.dateTimeGrouping == ZDataGridViewFilterMenuDateTimeGrouping.None)
                            {
                            ...
                            else
                            {
                                ...
                                foreach (var y in years)
                                {
                                    ...
                                    if (this.dateTimeGrouping == ZDataGridViewFilterMenuDateTimeGrouping.Year)
                                    {
                                        foreach (var d in y)
                                    ...
                                    else
                                    {
                                        ...
                                        foreach (var m in months)
                                        {
                                            ...
                                            if (this.dateTimeGrouping == ZDataGridViewFilterMenuDateTimeGrouping.Month || !hasTime)
                                            {
                                                foreach (var d in m)
                                            ...
                                            else
                                            {
                                                ...
                                                foreach (var d in days)
                                                {
                                                    ...
                                                    if (this.dateTimeGrouping == ZDataGridViewFilterMenuDateTimeGrouping.Day)
                                                    {
                                                        foreach (var t in d)
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            var hoursnode = daysnode.CreateChildNode(h.Key.ToString("D2") + " " + "h", h.Key);

                                                            if (this.dateTimeGrouping == ZDataGridViewFilterMenuDateTimeGrouping.Hour)
                                                            {
                                                                foreach (var t in h)
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                {
                                                                    var minsnode = hoursnode.CreateChildNode(mn.Key.ToString("D2") + " " + "m", mn.Key);

                                                                    if (this.dateTimeGrouping == ZDataGridViewFilterMenuDateTimeGrouping.Minute)
                                                                    {
                                                                        foreach (var t in mn)
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        {
                                                                            var secsnode = minsnode.CreateChildNode(s.Key.ToString("D2") + " " + "s", s.Key);
                                                                            ...
                                                                            foreach (var ms in msecs)
                                                                                secsnode.CreateChildNode(ms.Key.ToString("D3") + " " + "ms", ms.First());
                                                                        }
                                                                    }
                                                                }
                                                            }
                        ...
                        else if (this.DataType == ZDataGridViewFilterMenuDataType.Boolean)
                        {
                            if (nonullsCnt > 1)
                            {
                                nodes.Add(TripleTreeNode.CreateNode("No", false, valuesToCheck.Contains(false) ? CheckState.Checked : CheckState.Unchecked));
                                nodes.Add(TripleTreeNode.CreateNode("Yes", true, valuesToCheck.Contains(true) ? CheckState.Checked : CheckState.Unchecked));
                            }
                            else if ((Boolean)values.First())
                            {
                                nodes.Add(TripleTreeNode.CreateNode("Yes", true));
                            }
                            else
                                nodes.Add(TripleTreeNode.CreateNode("No", false));
                        }
                        else
                        {
                            foreach (var v in values.OrderBy(o => o))
                            {
                                nodes.Add(TripleTreeNode.CreateNode(v.ToString(), v, valuesToCheck.Contains(v)?CheckState.Checked:CheckState.Unchecked));
                            }
                        }
                    }
                }
        ...
        private string CreateFilterString()
        {
            ...
            if (nodes.Count() > 0)
            {
                if (this.DataType == ZDataGridViewFilterMenuDataType.Boolean)
                {
                    if (nodes.Count() == 1)
                ...
                else
                {
                    ...
                    else if (this.DataType == ZDataGridViewFilterMenuDataType.Int)
                    {
                        foreach (var n in nodes)
                            sb.Append(n.Value.ToString() + ", ");
                    }
                    else if (this.DataType == ZDataGridViewFilterMenuDataType.Float)
                    {
                        foreach (var n in nodes)
        ...
        private void SelectCustomFilter(int filtersMenuItemIndex, bool fireEvent = true)
        {
            ...
            this.ActiveFilterType = ZDataGridViewFilterType.Custom;
        ...
        private void SetSortingUI(ZDataGridViewSortType sort)
        {
        ...
        {
            this.SetSortingUI(ZDataGridViewSortType.ASC);
        ...
        {
            this.SetSortingUI(ZDataGridViewSortType.DESC);
        ...
        public string GetViewFilterString(string filterString)
        {
            Regex columnPattern = new Regex(@"^[\[](?<column>.+?)[\]]\s(?<command>IN|NOT LIKE|LIKE|=|<>|>|<|>=|<=)\s[(]?(?<value>.+?)[)]?$", RegexOptions.Compiled | RegexOptions.Singleline);

            Match columnMatch = columnPattern.Match(filterString);
            if (!columnMatch.Success) return filterString.Replace("[{0}]", "");
            ...
            string value = columnMatch.Groups["value"].Value;
            
            value = value.Trim(' ', '\'');
            isEndLike = isEndLike || value.StartsWith("%");
            isBeginLike = isBeginLike || value.EndsWith("%");
            value = value.Trim('%');
            ...
            return "Show rows where value" + " " + condition + " \"" + value + "\"";
        }

        public void SetSetupFilterMenuItem(string filterString)
        {
            string viewFilterString =GetViewFilterString(filterString);
            Int32 index = -1;
            ...
            for (Int32 i = 2; i < this.FiltersMenuItem.DropDownItems.Count; i++)
            {
                ...
                {
                    if (this.FiltersMenuItem.DropDownItems[i].Text == viewFilterString && this.FiltersMenuItem.DropDownItems[i].Tag.ToString() == filterString)
                    {
                        index = i;
                        break;
                    }
        ...
        {
            ZDataGridViewFilterForm flt = new ZDataGridViewFilterForm(this.DataType);
        ...
        internal void okButton_Click(object sender, EventArgs e)
        {
            ...
            {
                this.ActiveFilterType = ZDataGridViewFilterType.CheckList;
                string newfilter = "";
                ...
                if (this.CheckList.Nodes.Count > 1)
                {
                    ...
                    else if (this.DataType == ZDataGridViewFilterMenuDataType.Boolean && newfilter == "")
                    {
            ...
            this.Close();
            if (isFilterChanged) this.FilterChanged(this, new EventArgs());
        }
        ...
        private void ResizeMenu(int W, int H)
        {
            ...
            this.CheckFilterListButtonsPanel.Size = new Size(W - 35, 24);
            this.okButton.Location = new Point(W - 35 - 178, 0);
            this.cancelButton.Location = new Point(W - 35 - 86, 0);

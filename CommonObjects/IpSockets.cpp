...
CIpSocket::CIpSocket()
{
	...
	interfaceIPAddress_ = INADDR_ANY;
	m_dwLastErrorCode = 0;
...
LOGICAL CIpSocket::Bind(unsigned short uPort, IPADDRESS_TYPE InterfaceIpAddress/* = INADDR_ANY */)
{
	...
	interfaceIPAddress_ = InterfaceIpAddress;
	SocketParams.sin_addr.s_addr = interfaceIPAddress_;
...
)
{
	...
	from.sin_addr.S_un.S_addr = interfaceIPAddress_;
